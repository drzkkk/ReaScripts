-- @description Delete selected MIDI notes or note under mouse if none selected
-- @version 1.0
-- @tags midi, delete, notes
...
local function DeleteNoteUnderMouse()
...
local function main()
  ...
  if CountSelectedMIDINotes(take) > 0 then
    ...
    DeleteNoteUnderMouse()
  end

  reaper.Undo_EndBlock("Delete selected notes or note under mouse", -1)
