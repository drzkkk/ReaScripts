-- @description Toggle select ODD items on track or selected items if any
-- @version 1.0
-- @tags odd items
...
local r = reaper
local state_key = "toggle_odd_selection"
...
r.PreventUIRefresh(-1)
r.Undo_EndBlock("Toggle select odd items on track", -1)
r.UpdateArrange()