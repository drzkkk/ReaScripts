-- @description Move MIDI notes down one octave if none selected, move all notes
-- @version 1.0
-- @tags midi, notes, move notes down
-- @changelog First version
-- @author drzk

local transposeAmount = -12
...
local function main()
  ...
  reaper.Undo_EndBlock("Move notes down one octave", -1)
